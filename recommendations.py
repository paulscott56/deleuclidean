...
# Returns a distance based similarity (Euclidian score) for person 1 and person2
...
def sim_pearson(prefs, p1, p2):
    ...
    # if there is nothing in common return 0
    if n == 0: return 0
...
def getRecommendations(prefs, person, similarity = sim_pearson):
    ...
    for other in prefs:
        ...
        for item in prefs[other]:
            #only score things I haven't seen yet
